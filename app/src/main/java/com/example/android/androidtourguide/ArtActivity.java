...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locations.add(new Location(R.string.name_tours_adler, R.string.desc_tours_adler, R.drawable.adler));
        locations.add(new Location(R.string.name_tours_art, R.string.desc_tours_art, R.drawable.art));
